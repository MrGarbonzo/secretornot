...
from classifier.rule_filter import RuleMatch, check as rule_check
from classifier.model_classifier import classify as model_classify
from config import CONFIDENCE_THRESHOLD, DEFAULT_POLICY
from models import (
    Classification,
...
async def decide(text: str) -> ClassificationResult:
    ...
    rule_result: RuleMatch = rule_check(text)
